...
import styles from "./setup-network-variables1.module.css";
      ...
      <main className={styles.cousinTwiceRemovedNodes}>
        ...
        <div className={styles.sidebarMenu1}>
          <div className={styles.tab3}>
            <div className={styles.label}>coreum/asset/ft</div>
          </div>
          <div className={styles.tab4}>
            <div className={styles.expandedMenu3}>
              <div className={styles.tab5}>
                <div className={styles.label1}>authz.proto</div>
              </div>
              <div className={styles.tab6}>
                <div className={styles.label2}>event.proto</div>
              </div>
              <div className={styles.tab7}>
                <div className={styles.label3}>params.proto</div>
              </div>
              <div className={styles.tab8}>
                <div className={styles.label4}>query.proto</div>
              </div>
              <div className={styles.tab9}>
                <div className={styles.label5}>token.proto</div>
              </div>
              <div className={styles.tab10}>
                <div className={styles.label6}>tx.proto</div>
              </div>
            </div>
          </div>
        </div>
